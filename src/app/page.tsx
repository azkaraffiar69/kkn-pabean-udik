        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
          <div className="max-w-xl">
            <h2 className="text-6xl font-black tracking-tighter text-[#174143] leading-none mb-8">
              Meet <span className="font-serif italic font-light opacity-100 leading-none text-7xl"> The Team.</span>
            </h2>
          ...
          <div>
            ...
            <div className="space-y-12">
              <div className="group flex gap-8 items-start">
                <div className="w-14 h-14 bg-[#174143] text-white rounded-2xl flex items-center justify-center flex-shrink-0 shadow-xl">
              ...
              <div className="group flex gap-8 items-start">
                <div className="w-14 h-14 bg-gray-50 text-[#174143] rounded-2xl flex items-center justify-center flex-shrink-0 border border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-[#174143] font-bold text-lg">pabeanudik26@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
          <div className="h-[400px] bg-gray-50 rounded-[4rem] overflow-hidden border border-gray-100 shadow-3xl">
             <div className="w-full h-full flex items-center justify-center text-gray-400 italic">Map Placeholder</div>
          </div>
        </div>
      </section>
