...
<section id="team" className="py-20 md:py-20 overflow-x-hidden">
  {/* Bungkus judul dengan kontainer agar tetap sejajar dengan grid website */}
  ...
  {/* MemberCarousel sekarang berada di luar kontainer max-w-7xl */}
  {allMembers.length === 0 ? (
